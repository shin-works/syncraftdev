...
if (baseIndex.includes('data-design="lagoon-offset"')) {
  throw new Error('This legacy translator targets the old LP markup. Edit public/timesense/zh-hant/index.html and zh-hans/index.html directly; the new layout uses shared assets/redesign/site.css and site.js. Run python3 scripts/check-timesense-pages.py to verify protected copy. See docs/timesense-redesign-implementation.md.');
}
